...
def run():
    ...
    try:
        ...
        # استخراج روابط vless, vmess, trojan, ss
...
<head>
    ...
    <style>
        ...
        h1 {{ background: linear-gradient(to right, #00f2fe, #4facfe); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-size: 2.2rem; margin: 0; }}
        ...
        .link-box {{ background: rgba(0,0,0,0.3); padding: 8px; border-radius: 8px; font-size: 10px; color: #666; margin-top: 10px; word-break: break-all; direction: ltr; text-align: left; max-height: 40px; overflow: hidden; border: 1px solid rgba(255,255,255,0.03); }}
    </style>
</head>
<body>
    <header><h1>V2Ray Hub 🚀</h1><p style="color:#444">تحديث تلقائي من @g33sd</p></header>
    <div class="container">{cards if links else '<p style="text-align:center;color:#555">جاري جلب السيرفرات...</p>'}</div>
